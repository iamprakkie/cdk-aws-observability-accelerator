...
export class AMGNestedStack extends NestedStack {
    constructor(scope: Construct, id: string, props: AMGNestedStackProps ) {
        ...
        new cdk.CfnOutput(this, 'WorkspaceID', { value: workspace ? workspace.attrId : "none", exportName: 'WorkspaceID' });

        // const amg = new AWS.Grafana();

        // var params = {
        //     keyName: 'TEST_KEY', /* required */
        //     keyRole: 'VIEWER', /* required */
        //     secondsToLive: 1000, /* required */
        //     workspaceId: `${workspaceId}` /* required */
        //   };


        //   console.log(typeof(workspaceId), workspaceId);

        //   amg.createWorkspaceApiKey(params, function(err, data) {
    ...
    public static builder(props: AMGNestedStackProps): blueprints.NestedStackBuilder {
        return {
